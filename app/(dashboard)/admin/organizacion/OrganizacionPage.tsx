...
import {
  ...
  FileKey, Copy, PowerOff, Plus, Landmark,
  Download, UploadCloud, AlertCircle, CheckCircle2, Lock, Users,
} from 'lucide-react';
import UserRoleManager from './UserRoleManager';
import type { TenantUser } from './actions';
...
export function OrganizacionPageClient({ users, currentUserId, canEdit }: Props) {
  const [activeTab, setActiveTab] = useState<
    'perfil' | 'sucursales' | 'entidades' | 'organigrama' | 'regional' | 'usuarios'
  >('perfil');
