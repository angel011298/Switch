    ...
    <LegalLayout>
      <article>
        ...
        <Section id="1" title="1. Identidad y Domicilio del Responsable">
          <p>
            El responsable del tratamiento de sus datos personales es <strong>Angel Alberto Ortiz Sánchez</strong> (en adelante <strong>&quot;CIFRA ERP&quot;</strong>):
          </p>
          <div className="p-4 bg-neutral-50 dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 text-sm text-neutral-600 dark:text-neutral-400 not-prose">
        ...
        <Section id="2" title="2. Datos Personales Recabados">
          ...
          <p className="text-xs text-neutral-500 mt-2">
            CIFRA ERP <strong>no recaba datos sensibles</strong> (biometría, estado de salud, origen racial, filiación política o religiosa) en los términos del Art. 3, fracción VI de la LFPDPPP.
          </p>
        </Section>
        ...
        <Section id="4" title="4. Transferencia de Datos Personales">
          <p>Transferencias necesarias (no requieren consentimiento conforme al Art. 37 LFPDPPP):</p>
          <div className="space-y-2 mt-3">
            {[
              { dest: 'SAT y PAC (SW Sapien)', purpose: 'Timbrado, validación y cancelación de CFDI conforme al Art. 29 CFF.' },
              { dest: 'Stripe', purpose: 'Procesamiento seguro del cobro de suscripciones (PCI-DSS Level 1). CIFRA nunca almacena datos de tarjetas.' },
              { dest: 'Supabase', purpose: 'Infraestructura de base de datos PostgreSQL con aislamiento por Tenant y cifrado en reposo.' },
              { dest: 'Vercel', purpose: 'Hospedaje de la aplicación y CDN. No procesa datos personales del usuario final.' },
              { dest: 'Resend', purpose: 'Envío de correos transaccionales. Solo recibe el correo de destino y el contenido del mensaje.' },
            ].map((t, i) => (
        ...
        <Section id="6" title="6. Derechos ARCO">
          <p>Usted tiene derecho a Acceder, Rectificar, Cancelar y Oponerse al tratamiento de sus datos personales.</p>
          <div className="p-4 bg-emerald-50 dark:bg-emerald-500/10 rounded-xl border border-emerald-200 dark:border-emerald-500/20 mt-3">
            <p className="font-bold text-emerald-800 dark:text-emerald-200 text-sm mb-2">Procedimiento de solicitud ARCO</p>
            <ol className="text-xs text-emerald-700 dark:text-emerald-300 space-y-1 list-decimal list-inside">
              ...
              <li>Describa claramente los datos sobre los que desea ejercer su derecho.</li>
            </ol>
            <p className="text-xs text-emerald-600 dark:text-emerald-400 mt-2">
              Recibirá respuesta en máximo <strong>20 días hábiles</strong>.
            </p>
          </div>
        </Section>
        ...
        <Section id="7" title="7. Uso de Cookies y Tecnologías de Rastreo">
          <p>
            CIFRA ERP utiliza cookies esenciales para mantener su sesión activa, y cookies opcionales de preferencias y analíticas.
        ...
        <Section id="8" title="8. Medidas de Seguridad">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li><strong>Cifrado en reposo:</strong> Base de datos PostgreSQL cifrada (Supabase).</li>
            <li><strong>Aislamiento multi-tenant:</strong> Cada empresa tiene su propia instancia lógica de datos.</li>
            ...
            <li><strong>AuditLog:</strong> Registro inmutable de todas las operaciones críticas.</li>
        ...
        <Section id="9" title="9. Autoridad Competente">
          Si considera que su derecho a la protección de datos ha sido lesionado, puede presentar queja ante la <strong>Secretaría Anticorrupción y Buen Gobierno</strong> (o la autoridad que asuma sus funciones).
        </Section>

        <Section id="10" title="10. Modificaciones al Aviso">
          Cualquier modificación se notificará mediante banner destacado en el dashboard y/o correo electrónico al correo registrado.
        </Section>
